package net.explorviz.shared.landscape.model.store.helper;
...
public final class TimestampHelper {
  ...
  /**
   * Retrieves timestamps AFTER a passed {@link net.explorviz.shared.landscape.model.store.Timestamp}.
   *
