...
public class ProcezzStartMapper implements ExceptionMapper<ProcezzStartException> {

  private static final Logger LOGGER = LoggerFactory.getLogger(ProcezzStartMapper.class);

  @Override
  public Response toResponse(final ProcezzStartException exception) {
